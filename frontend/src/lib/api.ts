...
export async function analyzeFile(file: File, modelType: string = 'claude', onProgress?: (p: number) => void): Promise<AnalyzeResponse> {
...
export async function analyzeText(text: string, modelType: string = 'claude', name?: string): Promise<AnalyzeResponse> {
